...
const SubscriptionPage: React.FC = () => {
  ...
  const handleInputChange = (
    ...
    setEditedPlan({
      ...editedPlan,
      [name]:
        name === "halfyearly_price" || name === "annually_price"
          ? parseFloat(value) || 0
          : value,
    });
  };
  ...
  const deletePlan = async () => {
    ...
    try {
      const response = await fetch(
        `/api/subscription/${selectedPlan.plan_id}`,
        {
          method: "DELETE",
          headers: { "Content-Type": "application/json" },
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button
          onClick={() =>
            router.push("/super-admin/database/subscription/subscription-management/addplan")
          }
        >
          Add New Plan
        </Button>
          ...
          <DialogContent className="text-black">
            <DialogHeader>
              ...
              <DialogDescription className="text-black">
                Are you sure you want to delete the plan "{selectedPlan.plan}"?
